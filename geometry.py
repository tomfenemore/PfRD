...
class geometry():
    ...
    def __init__(self, buckle_thk, b, bkl_psn, E_root):
        ...
        self.force_func =  (34 * self.span)/(self.span - self.bkl_psn) * self.E_root  # FRom last year force required for buckle onset
        #self.twist_at_node()
