...
u800 = np.array(f.steps['nlan'].historyRegions['Node ASSEMBLY.8'].historyOutputs['UR3'].data)
u700 = np.array(f.steps['nlan'].historyRegions['Node ASSEMBLY.7'].historyOutputs['UR3'].data)
u600 = np.array(f.steps['nlan'].historyRegions['Node ASSEMBLY.6'].historyOutputs['UR3'].data)
u500 = np.array(f.steps['nlan'].historyRegions['Node ASSEMBLY.5'].historyOutputs['UR3'].data)
u400 = np.array(f.steps['nlan'].historyRegions['Node ASSEMBLY.4'].historyOutputs['UR3'].data)
u300 = np.array(f.steps['nlan'].historyRegions['Node ASSEMBLY.3'].historyOutputs['UR3'].data)
u200 = np.array(f.steps['nlan'].historyRegions['Node ASSEMBLY.2'].historyOutputs['UR3'].data)
u100 = np.array(f.steps['nlan'].historyRegions['Node ASSEMBLY.1'].historyOutputs['UR3'].data)
